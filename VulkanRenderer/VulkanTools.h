...
namespace vkTools
{
    ...
    namespace initializers
    {
        ...
        inline VkAttachmentDescription attachmentDescInfo(VkImageLayout imageLayout)
        {
        ...
        inline VkAttachmentReference attachmentRefInfo(uint32_t attachment, VkImageLayout imageLayout)
        {
