 ...
 */
class ENTITYX_API BaseSystem : entityx::help::NonCopyable {
 public:
   ...
   * Typically used to set up event handlers.
   */
  virtual void shutdown(EntityManager &entities, EventManager &events) {
    shutdown(events);
  }

  /**
   * Legacy shutdown(). Called by default implementation of shutdown(EntityManager&, EventManager&).
   */
  virtual void shutdown(EventManager &events) {}
...
class ENTITYX_API SystemManager : entityx::help::NonCopyable {
 public:
